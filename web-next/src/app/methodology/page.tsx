  ...
  return (
    <Container className="py-12">
      ...
      <div className="mt-8 flex max-w-3xl flex-col gap-5">
        ...
        <Section title="How the build tools work">
          The Build Studio and the Counter Builder use a language model to choose the items
          and runes, and a deterministic engine to do the maths. Every damage, survivability
          and time-to-kill figure shown beside a build is simulated from the item and ability
          data on this site rather than produced by the model, so the numbers are reproducible
          and can be checked. The engine measures output against a target, not positioning or
          who lands a skillshot first.
        </Section>
