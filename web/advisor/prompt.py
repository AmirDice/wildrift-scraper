    ...
    if matchup:
        ...
        lines.append(
            ...
            + " THE RUNE PAGE IS THE LANE'S ANSWER FIRST: runes are bought for the "
              "laning phase. Into sustained poke or a ranged bully, take sustain or "
              "regeneration where the page LEGALLY allows it; into burst all-ins, "
              "damage mitigation the same way. THE PAGE MUST STAY LEGAL: three "
              "minors from the primary tree plus exactly ONE off-tree flex. An "
              "off-tree sustain rune (for example a Resolve rune on a Precision "
              "page) can ONLY be the flex -- never a minor slot. If one flex slot "
              "of sustain is not enough for this lane, switch the primary tree "
              "instead of breaking the page. This adjusts the RUNE page and at "
              "most nudges the early items: do not stack multiple exclusive "
              "defensive items (lifeline group) to answer one laner. Keep the "
